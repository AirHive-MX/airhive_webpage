  ...
  return (
    <main className="ah-page px-6 pb-16 pt-32">
      ...
      <section className="ah-container grid gap-12 pb-16 lg:grid-cols-2">
        <article
          className="ah-blue-card rounded-3xl border p-6 transition duration-500 sm:p-8 border-[#DDDDDD] bg-white shadow-[0_12px_30px_rgba(22,42,66,0.1)]"
        >
          ...
          <ul className="mt-6 space-y-4">
            {[t("diagnostic_page.for_1"), t("diagnostic_page.for_2"), t("diagnostic_page.for_3"), t("diagnostic_page.for_4")].map((item, idx) => {
              ...
              return (
                <li key={item} className="flex items-start gap-3 border-b pb-4 last:border-b-0 last:pb-0 border-[#DDDDDD]/80">
                  <Icon className="mt-0.5 h-4.5 w-4.5 text-[#2A47F6]" strokeWidth={1.8} />
                  <p className="text-sm sm:text-base text-[#202020]/80">{item}</p>
                </li>
              );
            })}
          </ul>
        ...
        >
          ...
          <div className="mt-6 space-y-3">
            {steps.map((step, idx) => (
              <div
                key={step}
                className="flex items-center gap-3 rounded-2xl border p-3 border-[#DDDDDD] bg-white shadow-[0_6px_16px_rgba(22,42,66,0.06)]"
              >
                <span
                  className="inline-flex h-7 w-7 items-center justify-center rounded-full text-xs font-semibold bg-[#2A47F6]/12 text-[#2A47F6]"
                >
                  {idx + 1}
                </span>
                <p className="text-sm sm:text-base text-[#202020]/82">{step}</p>
              </div>
            ))}
          </div>
        </article>
      ...
      <section className="ah-container pb-16">
        <h2 className="text-2xl font-semibold sm:text-3xl text-[#162A42]">{t("diagnostic_page.mock_title")}</h2>
        <div
          className="ah-blue-card mt-6 rounded-3xl border p-6 transition duration-500 sm:p-8 border-[#DDDDDD] bg-white shadow-[0_12px_30px_rgba(22,42,66,0.1)]"
        >
          <div className="grid gap-5 lg:grid-cols-3">
            <div
              className="rounded-2xl border p-4 border-[#DDDDDD] bg-white shadow-[0_6px_16px_rgba(22,42,66,0.06)]"
            >
              <p className="mb-3 text-xs font-semibold uppercase tracking-[0.18em] text-[#6443DB]">{t("diagnostic_page.mock_map")}</p>
              <div className="space-y-3 text-xs sm:text-sm text-[#162A42]/85">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div
                  className="rounded-lg border p-2 border-[#DDDDDD] bg-[#2A47F6]/7"
                >{t("diagnostic_page.mock_matrix_1")}</div>
                <div
                  className="rounded-lg border p-2 border-[#DDDDDD]"
                >{t("diagnostic_page.mock_matrix_2")}</div>
                <div
                  className="rounded-lg border p-2 border-[#DDDDDD]"
                >{t("diagnostic_page.mock_matrix_3")}</div>
                <div
                  className="rounded-lg border p-2 border-[#DDDDDD] bg-[#6443DB]/10"
            ...
            >
              ...
              <div className="space-y-3 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="h-2 rounded-full" style={{ background: 'rgba(42,71,246,0.2)' }}>
      ...
      <section className="ah-container grid gap-10 pb-6 lg:grid-cols-[1fr_1.1fr]">
        <article
          className="ah-blue-card rounded-3xl border p-6 transition duration-500 sm:p-8 bg-white border-[#162A42]/10 shadow-[0_12px_30px_rgba(22,42,66,0.1)]"
        >
          <h2 className="text-2xl font-semibold sm:text-3xl text-[#162A42]">{t("diagnostic_page.faq_title")}</h2>
          <div className="mt-5 space-y-3">
            {faqs.map((faq) => (
              <details
                key={faq.q}
                className="rounded-2xl border p-4 border-[#162A42]/10 bg-white shadow-[0_6px_16px_rgba(22,42,66,0.06)]"
              >
                <summary className="cursor-pointer list-none text-sm font-semibold sm:text-base text-[#162A42]">{faq.q}</summary>
