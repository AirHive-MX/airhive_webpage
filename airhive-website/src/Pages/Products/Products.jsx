        ...
        <div className="grid gap-6 md:grid-cols-2">
          {["logistics", "counting", "vision", "hardware"].map((key, i) => (
            <motion.article
              ...
              className="rounded-2xl border border-[#2A47F6]/15 bg-white p-7 shadow-[0_14px_34px_rgba(22,42,66,0.08)] transition-shadow duration-300 hover:shadow-[0_20px_50px_rgba(42,71,246,0.18)] sm:p-8"
            >
              <p className="text-lg font-bold uppercase tracking-[0.14em] text-[#2A47F6]">{t(`products.other_products.${key}_title`)}</p>
              <p className="mt-3 text-base leading-relaxed text-[#202020]/74">{t(`products.other_products.${key}_text`)}</p>
            </motion.article>
          ))}
        </div>
      </section>
